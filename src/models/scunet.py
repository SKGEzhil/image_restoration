...
class WMSA(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, head_dim, window_size, type):
        ...
        # Precompute coordinate grid for relative embedding (avoid numpy in forward)
        cord = torch.tensor(
    ...
    def forward(self, x):
        ...
        output = rearrange(
            output, "b (w1 w2) (p1 p2) c -> b (w1 p1) (w2 p2) c",
